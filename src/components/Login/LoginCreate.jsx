...
const LoginCreate = () => {
  ...
  const { userLogin } = React.useContext(UserContext); // Desestrutura o retorno da função useContext e armazena a função userLogin na constante userLogin. O useContext é responsável por acessar o contexto que foi criado no arquivo UserContext.jsx.
